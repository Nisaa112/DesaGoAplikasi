...
class PengeluaranItem {
  ...
  PengeluaranItem({required this.deskripsi, required this.jumlah, required this.tanggal});
}
...
class PengeluaranPage extends StatelessWidget {
  ...
  String _formatCurrency(double amount) {
    ...
    // Menggunakan replaceAll untuk mendapatkan format Rp1.234.567.00
          ...
          content: SingleChildScrollView(
            child: Column(
              ...
              children: <Widget>[
                ...
                const SizedBox(height: 8),
                _buildTextField('Cth: Pembelian hadiah lomba', primaryColor),
                const SizedBox(height: 16),
    ...
    return Scaffold(
      ...
      body: Container(
        ...
        child: ClipRRect(
          ...
          // Tambahkan padding bawah ke list view agar FAB tidak menutupi item terakhir
          child: _buildPengeluaranList(),
        ),
      ),
      
      // MARK: - Floating Action Button (FAB) untuk Tambah Pengeluaran
  ...
  Widget _buildPengeluaranList() {
    return ListView.separated(
      // Tambahkan padding bawah agar FAB tidak menutupi item terakhir
      padding: const EdgeInsets.only(top: 8.0, bottom: 80.0), 
      itemCount: dummyPengeluaran.length,
      itemBuilder: (context, index) {
        final item = dummyPengeluaran[index];
        ...
        return Padding(
          ...
          child: ListTile(
            ...
            trailing: Column(
              ...
              children: [
                Text(
                  _formatDateLite(item.tanggal).split(', ')[1].replaceAll(' 2025', ''), 
            ...
            onTap: () {
              ScaffoldMessenger.of(context).showSnackBar(
                SnackBar(content: Text('Detail Pengeluaran: ${item.deskripsi}')),
              );
            },
          ),
        );
