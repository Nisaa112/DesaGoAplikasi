...
import 'package:desa_go_aplikasi/page/detail_laporan_ronda_page.dart';
import 'package:flutter/material.dart';

class LaporanRondaPage extends StatelessWidget {
              ...
              return ListTile(
                ...
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => DetailLaporanRondaPage(reportTitle: laporanTitle),
                    ),
                  );
                },
              );
